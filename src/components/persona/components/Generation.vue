    ...
    <chart-container>
        ...
        <div class="charts-wrapper">
            <vu-echarts class="charts">
                <marked-hog-chart v-if="showChart" :option="data"></marked-hog-chart>
            </vu-echarts>
        </div>
    </chart-container>
</template>
...
export default {
    components: {
        ...
        MarkedHogChart: () => import('@/components/charts/vu-echarts/MarkedHogChart')
    },
    props: {
        type: {
            required: true,
        ...
        onConditionChange () {
            ...
            case types.CUSTOMER_FLOW:
                if(queryConditions) {
                    ...
                    getter = this.getter = DataGetter.createAjaxGetter(getAgeCoverage, {
                ...
                break;
            case types.VIP:
                getter = this.getter = DataGetter.createAjaxGetter(getMemberAgeCoverage, {
            ...
            case types.CUSTOM:
                if(queryConditions) {
                    getter = this.getter = DataGetter.createAjaxGetter(getCustomAgeCoverage, {
