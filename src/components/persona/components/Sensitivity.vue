        ...
        onConditionChange () {
            ...
            case types.CUSTOMER_FLOW:
                if(queryConditions) {
                    ...
                    getter = this.getter = DataGetter.createAjaxGetter(getSalesPromotionAnalysis, {
                ...
                break;
            case types.VIP:
                getter = this.getter = DataGetter.createAjaxGetter(getMemberSalesPromotionAnalysis, {
            ...
            case types.CUSTOM:
                if(queryConditions) {
                    getter = this.getter = DataGetter.createAjaxGetter(getCustomSalesPromotionAnalysis, {
