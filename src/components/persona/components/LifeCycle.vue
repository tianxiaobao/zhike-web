        ...
        onConditionChange () {
            ...
            case types.CUSTOMER_FLOW:
                if(queryConditions) {
                    ...
                    if(this.currentMall.id === 0) {
                        getter = this.getter = DataGetter.createJsonGetter(() => import('@/assets/json/life-cycle.json'));
                    } else {
                        getter = this.getter = DataGetter.createAjaxGetter(getCustomerLifeCycle, {
            ...
            case types.VIP:
                if(this.currentMall.id === 0) {
                    ...
                    getter = this.getter = DataGetter.createAjaxGetter(getMemberCustomerLifeCycle, {
            ...
            case types.CUSTOM:
                if(queryConditions) {
                    if(this.currentMall.id === 0) {
                        ...
                        getter = this.getter = DataGetter.createAjaxGetter(getCustomCustomerLifeCycle, {
