<template>
    <chart-container>
        <div slot="header">
            <h2>{{ queryConditions.category }}品牌排名</h2>
        </div>
        ...
        onConditionChange () {
            ...
            case types.CUSTOMER_FLOW:
                if(queryConditions) {
                    ...
                    const getter = this.getter = DataGetter.createAjaxGetter(getBrandBySelect, {
            ...
            case types.VIP:
                if(queryConditions) {
                    const getter = this.getter = DataGetter.createAjaxGetter(getMemberBrandBySelect, {
            ...
            case types.CUSTOM:
                if(queryConditions) {
                    const getter = this.getter = DataGetter.createAjaxGetter(getCustomBrandBySelect, {
