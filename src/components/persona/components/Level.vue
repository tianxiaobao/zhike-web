        ...
        onConditionChange () {
            ...
            case types.CUSTOMER_FLOW:
                if(queryConditions) {
                    ...
                    getter = this.getter = DataGetter.createAjaxGetter(getJDLevelAnalysis, {
                ...
                break;
            case types.VIP:
                getter = this.getter = DataGetter.createAjaxGetter(getMemberJDLevelAnalysis, {
            ...
            case types.CUSTOM:
                if(queryConditions) {
                    getter = this.getter = DataGetter.createAjaxGetter(getCustomJDLevelAnalysis, {
