        ...
        onConditionChange () {
            ...
            case types.CUSTOMER_FLOW:
                if(queryConditions) {
                    ...
                    if(this.currentMall.id === 0) {
                        getter = this.getter = DataGetter.createJsonGetter(() => import('@/assets/json/children-age.json'));
                    } else {
                        getter = this.getter = DataGetter.createAjaxGetter(getChildrenAge, {
            ...
            case types.VIP:
                if(this.currentMall.id === 0) {
                    ...
                    getter = this.getter = DataGetter.createAjaxGetter(getMemberChildrenAge, {
            ...
            case types.CUSTOM:
                if(queryConditions) {
                    if(this.currentMall.id === 0) {
                        ...
                        getter = this.getter = DataGetter.createAjaxGetter(getCustomChildrenAge, {
