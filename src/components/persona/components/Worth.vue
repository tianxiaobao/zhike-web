        ...
        onConditionChange () {
            ...
            case types.CUSTOMER_FLOW:
                if(queryConditions) {
                    ...
                    if(this.currentMall.id === 0) {
                        getter = this.getter = DataGetter.createJsonGetter(() => import('@/assets/json/worth.json'));
                    } else {
                        getter = this.getter = DataGetter.createAjaxGetter(getCustomerWorth, {
            ...
            case types.VIP:
                if(this.currentMall.id === 0) {
                    ...
                    getter = this.getter = DataGetter.createAjaxGetter(getMemberCustomerWorth, {
            ...
            case types.CUSTOM:
                if(queryConditions) {
                    if(this.currentMall.id === 0) {
                        ...
                        getter = this.getter = DataGetter.createAjaxGetter(getCustomCustomerWorth, {
