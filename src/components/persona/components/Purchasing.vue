        ...
        onConditionChange () {
            ...
            case types.CUSTOMER_FLOW:
                if(queryConditions) {
                    ...
                    getter = this.getter = DataGetter.createAjaxGetter(getPurchasingPowerAnalysis, {
                ...
                break;
            case types.VIP:
                getter = this.getter = DataGetter.createAjaxGetter(getMemberPurchasingPowerAnalysis, {
            ...
            case types.CUSTOM:
                if(queryConditions) {
                    getter = this.getter = DataGetter.createAjaxGetter(getCustomPurchasingPowerAnalysis, {
