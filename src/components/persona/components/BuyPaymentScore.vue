...
const optionsConfig = [{
    ...
    value: 7,
    api: getRfmMScoreD7,
    memberApi: getMemberRfmMScoreD7,
    customApi: getCustomRfmMScoreD7
}, {
    label: '15天',
    value: 15,
    api: getRfmMScoreD15,
    memberApi: getMemberRfmMScoreD15,
    customApi: getCustomRfmMScoreD15
}, {
    label: '30天',
    value: 30,
    api: getRfmMScoreD30,
    memberApi: getMemberRfmMScoreD30,
    customApi: getCustomRfmMScoreD30
}, {
    label: '90天',
    value: 90,
    api: getRfmMScoreM3,
    memberApi: getMemberRfmMScoreM3,
    customApi: getCustomRfmMScoreM3
}];
export default {
    components: {
        ChartContainer,
