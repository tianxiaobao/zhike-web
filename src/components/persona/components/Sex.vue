        ...
        onConditionChange () {
            ...
            case types.CUSTOMER_FLOW:
                if(queryConditions) {
                    ...
                    getter = this.getter = DataGetter.createAjaxGetter(getSexCoverage, {
                ...
                break;
            case types.VIP:
                getter = this.getter = DataGetter.createAjaxGetter(getMemberSexCoverage, {
            ...
            case types.CUSTOM:
                if(queryConditions) {
                    getter = this.getter = DataGetter.createAjaxGetter(getCustomSexCoverage, {
