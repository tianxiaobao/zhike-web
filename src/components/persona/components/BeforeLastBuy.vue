        ...
        onConditionChange () {
            ...
            case types.CUSTOMER_FLOW:
                if(queryConditions) {
                    ...
                    if(this.currentMall.id === 0) {
                        getter = this.getter = DataGetter.createJsonGetter(() => import('@/assets/json/before-last-buy.json'));
                    } else {
                        getter = this.getter = DataGetter.createAjaxGetter(getRfmRValueAll, {
            ...
            case types.VIP:
                if(this.currentMall.id === 0) {
                    ...
                    getter = this.getter = DataGetter.createAjaxGetter(getMemberRfmRValueAll, {
            ...
            case types.CUSTOM:
                if(queryConditions) {
                    if(this.currentMall.id === 0) {
                        ...
                        getter = this.getter = DataGetter.createAjaxGetter(getCustomRfmRValueAll, {
