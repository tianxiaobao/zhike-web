<template>
    <chart-container class="customer-contribution">
        ...
        <vu-echarts class="chart">
            <rank-hog-chart v-if="showChart" :option="data"></rank-hog-chart>
        </vu-echarts>
    </chart-container>
</template>
...
import { getContributionTops } from '@/apis/customerFlow';
...
export default {
    components: {
        ...
        RankHogChart: () => import('@/components/charts/vu-echarts/RankHogChart')
    },
    beforeDestroy () {
        this.init();
    },
